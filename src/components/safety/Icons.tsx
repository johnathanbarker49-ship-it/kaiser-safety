...
export const FlaskIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M6 22h12"/>
    <path d="M6 2h12"/>
    <path d="M12 2v8l-6 12h12L12 10V2"/>
  </svg>
);
...
export const SirenIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M7 18v-6a5 5 0 1 1 10 0v6"/>
    <path d="M5 21a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-1a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v1z"/>
    <path d="M21 12h1"/>
    <path d="M18.5 4.5l.71.71"/>
    <path d="M2 12h1"/>
    <path d="M5.5 4.5l-.71.71"/>
    <path d="M12 2v1"/>
  </svg>
);
...
export const getCategoryIcon = (category: string): React.FC<IconProps> => {
  const icons: Record<string, React.FC<IconProps>> = {
    'Fall Protection': ShieldIcon,
    'WHMIS': FlaskIcon,
    'Hazard Assessment': AlertTriangleIcon,
    'Emergency Response': SirenIcon,
    'Training Records': GraduationCapIcon,
    'Toolbox Talks': WrenchIcon,
    'JHSC': UsersIcon,
